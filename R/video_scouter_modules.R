        ...
        showModal(vwModalDialog(title = "Edit teams",
                              ...
                              tabsetPanel(
                                  tabPanel("Home team",
                                           ...
                                           fluidRow(column(12, tags$div(style = "float:right; font-size:small; margin-left:12px;", "Fast start will auto-populate players 1-99 so you can start scouting and edit the roster later.", tags$br(), "But you will need to assign the libero roles to the correct player numbers."),
