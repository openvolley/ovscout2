...
player_responsibility_fn <- function(system = "SHM3", skill, setter_position, zone, libs, home_visiting, opp_attack_start_zone = NA, serving, n_blockers = NA) {
    ...
    if (system == "SHM3") {
        if (skill == "Reception") {
            ...
            ln <- if (loc) "libero" else NA_character_
            P1r <- setter_position %eq% 1 & !isTRUE(serving) ## P1 reception, opp and front-OH swapped
            if (opp_attack_start_zone %in% c(4,7,5)) {
                ret <- case_when(setter_position == 1 ~ case_when(zone %in% c(1,9) ~ paste0(home_visiting,"_p1"),
                                                                  zone == 2 & n_blockers > 0 ~ paste0(home_visiting,"_p1"), ## setter in p1 covers tips to 2
                                                                  zone == 2 & P1r ~ paste0(home_visiting,"_p2"), ## no block
                                                                  zone == 2 ~ paste0(home_visiting,"_p4"), ## no block
                                                                  zone %in% c(3,4) & P1r ~ paste0(home_visiting,"_p4"), ## off blocker covers tips
                                                                  zone %in% c(3,4) ~ paste0(home_visiting,"_p2"), ## off blocker covers tips to 3 and 4
                                                                  zone %in% c(5,7,8) & loc ~ ln,
                                                                  zone %in% c(5,7,8) ~ paste0(home_visiting,"_p6"),
                                                                  zone == 6 ~ paste0(home_visiting,"_p5")),
                                 setter_position == 2 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p6"),
                                                                  zone == 2 & n_blockers > 0 ~ paste0(home_visiting,"_p5"),
                                                                  zone == 2 ~ paste0(home_visiting,"_p2"), ## no block
                                                                  zone %in% c(3,4) ~ paste0(home_visiting,"_p3"),
                                                                  zone %in% c(1,9) ~ paste0(home_visiting,"_p5"),
                                                                  zone %in% c(5,7,8) & loc ~ ln,
                                                                  zone %in% c(5,7,8) ~ paste0(home_visiting,"_p1")),
                                 setter_position == 3 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p1"),
                                                                  zone %in% c(3,4) ~ paste0(home_visiting,"_p4"),
                                                                  zone %in% c(1,9) ~ paste0(home_visiting,"_p6"),
                                                                  zone == 2 & n_blockers > 0 ~ paste0(home_visiting,"_p6"),
                                                                  zone == 2 ~ paste0(home_visiting,"_p3"),
                                                                  zone %in% c(5,7,8) & loc ~ ln,
                                                                  zone %in% c(5,7,8) ~ paste0(home_visiting,"_p5")),
                                 setter_position == 4 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p5"),
                                                                  zone %in% c(3,4) ~ paste0(home_visiting,"_p2"),
                                                                  zone %in% c(1,9) ~ paste0(home_visiting,"_p1"),
                                                                  zone == 2 & n_blockers > 0 ~ paste0(home_visiting,"_p1"),
                                                                  zone == 2 ~ paste0(home_visiting,"_p4"),
                                                                  zone %in% c(5,7,8) & loc ~ ln,
                                                                  zone %in% c(5,7,8) ~ paste0(home_visiting,"_p6")),
                                 setter_position == 5 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p6"),
                                                                  zone %in% c(3,4) ~ paste0(home_visiting,"_p3"),
                                                                  zone %in% c(1,9) ~ paste0(home_visiting,"_p5"),
                                                                  zone == 2 & n_blockers > 0 ~ paste0(home_visiting,"_p5"),
                                                                  zone == 2 ~ paste0(home_visiting,"_p2"),
                                                                  zone %in% c(5,7,8) & loc ~ ln,
                                                                  zone %in% c(5,7,8) ~ paste0(home_visiting,"_p1")),
                                 setter_position == 6 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p1"),
                                                                  zone %in% c(3,4) ~ paste0(home_visiting,"_p4"),
                                                                  zone %in% c(1,9) ~ paste0(home_visiting,"_p6"),
                                                                  zone == 2 & n_blockers > 0 ~ paste0(home_visiting,"_p6"),
                                                                  zone == 2 ~ paste0(home_visiting,"_p3"),
                ...
                ret <- case_when(setter_position == 1 ~ case_when(zone %in% c(1,9) ~ paste0(home_visiting,"_p1"),
                                                                  zone == 2 & P1r ~ paste0(home_visiting,"_p2"),
                                                                  zone == 2 ~ paste0(home_visiting,"_p4"),
                                                                  zone %in% c(3,4) & P1r ~ paste0(home_visiting,"_p4"),
                                                                  zone %in% c(3,4) ~ paste0(home_visiting,"_p2"),
                                                                  zone %in% c(5,7,8) & loc ~ ln,
                                                                  zone %in% c(5,7,8) ~ paste0(home_visiting,"_p6"),
                                                                  zone == 6 ~ paste0(home_visiting,"_p5")),
                ...
                ret <- case_when(setter_position == 1 ~ case_when(zone %in% c(1,9,8) ~ paste0(home_visiting,"_p1"),
                                                                  zone == 4 & n_blockers > 0 & loc ~ ln,
                                                                  zone == 4 & n_blockers > 0 ~ paste0(home_visiting,"_p6"),
                                                                  zone == 4 & P1r ~ paste0(home_visiting,"_p4"), ## no block
                                                                  zone == 4 ~ paste0(home_visiting,"_p2"), ## no block
                                                                  zone %in% c(2,3) & P1r ~ paste0(home_visiting,"_p2"), ## off blocker covers tips
                                                                  zone %in% c(2,3) ~ paste0(home_visiting,"_p4"), ## off blocker covers tips to 3 and 4
                                                                  zone %in% c(5,7) & loc ~ ln,
                                                                  zone %in% c(5,7) ~ paste0(home_visiting,"_p6"),
                                                                  zone == 6 ~ paste0(home_visiting,"_p5")),
                                 setter_position == 2 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p6"),
                                                                  zone == 4 & n_blockers > 0 & loc ~ ln,
                                                                  zone == 4 & n_blockers > 0 ~ paste0(home_visiting,"_p1"),
                                                                  zone == 4 ~ paste0(home_visiting,"_p3"), ## no block
                                 ...
                                 setter_position == 3 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p1"),
                                                                  ...
                                                                  zone == 4 & n_blockers > 0 & loc ~ ln,
                                                                  zone == 4 & n_blockers > 0 ~ paste0(home_visiting,"_p5"),
                                                                  zone == 4 ~ paste0(home_visiting,"_p4"), ## no block
                                                                  zone %in% c(5,7) & loc ~ ln,
                                 ...
                                 setter_position == 4 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p5"),
                                                                  ...
                                                                  zone == 4 & n_blockers > 0 & loc ~ ln,
                                                                  zone == 4 & n_blockers > 0 ~ paste0(home_visiting,"_p6"),
                                                                  zone == 4 ~ paste0(home_visiting,"_p2"),
                                                                  zone %in% c(5,7) & loc ~ ln,
                                                                  zone %in% c(5,7) ~ paste0(home_visiting,"_p6")),
                                 setter_position == 5 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p6"),
                                                                  zone %in% c(2,3) ~ paste0(home_visiting,"_p2"),
                                                                  ...
                                                                  zone == 4 & n_blockers > 0 & loc ~ ln,
                                                                  zone == 4 & n_blockers > 0 ~ paste0(home_visiting,"_p1"),
                                                                  zone == 4 ~ paste0(home_visiting,"_p3"),
                                                                  zone %in% c(5,7) & loc ~ ln,
                                                                  zone %in% c(5,7) ~ paste0(home_visiting,"_p1")),
                                 setter_position == 6 ~ case_when(zone == 6 ~ paste0(home_visiting,"_p1"),
                                                                  zone %in% c(2,3) ~ paste0(home_visiting,"_p3"),
                                                                  ...
                                                                  zone == 4 & n_blockers > 0 & loc ~ ln,
                                                                  zone == 4 & n_blockers > 0 ~ paste0(home_visiting,"_p5"),
                                                                  zone == 4 ~ paste0(home_visiting,"_p4"),
                                                                  zone %in% c(5,7) & loc ~ ln,
                                                                  zone %in% c(5,7) ~ paste0(home_visiting,"_p5")))
            } else {
              ret <- NA_character_
