...
- the scouting process avoids unnecessarily asking for information (e.g. information that can be inferred by other means, such as the serving player), and tries to pre-fill as much information as it can at each data entry step. It will learn a team's passing and defensive patterns, so that it can suggest the most likely player to have passed or dug a certain ball

This software is unlikely to replace professional scouting software used by scouts who can already capture match data in real time. But for the rest of us ...
